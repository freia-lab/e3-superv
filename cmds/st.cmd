...
epicsEnvSet ("IOCNAME", "MJioc09-superv")

# Directory name for the autosave files
epicsEnvSet ("IOCDIR", "MJsuperv")
...
iocshLoad("$(superv_DIR)/tomcat-mon.iocsh", "IP_ADDR=http://freia-dbwr.physics.uu.se:8080,P=MJCtrl-freiaDbwr:tomcat-,PDEV=dbwr")
iocshLoad("$(superv_DIR)/tomcat-mon.iocsh", "IP_ADDR=http://freia.physics.uu.se:8080,P=MJCtrl-freia:tomcat-,PDEV=freia")
